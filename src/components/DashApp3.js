  ...
  return (
    <div className="content" style={{
      ...
      <button 
        ...
        style={{
          position: 'absolute',
          top: '60px',  // Adjusted to match the previous examples for consistent button position
          right: '20px',
          padding: '10px 20px',
      ...
      <div style={containerStyle}>
        ...
        <h1 style={titleStyle}>Sentiment Analysis</h1>
        <div>
        ...
        <div style={iframeContainerStyle}>
          <iframe title="dash-app" src="http://localhost:8061" style={iframeStyle}></iframe>
        </div>
      </div>
    </div>
  );
