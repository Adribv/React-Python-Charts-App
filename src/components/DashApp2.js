  ...
  return (
    <div className="content" style={{
      ...
      <button 
        ...
        style={{
          position: 'absolute',
          top: '60px',  // Adjusted to match the previous example for consistent button position
          right: '20px',
          padding: '10px 20px',
      ...
      <div style={containerStyle}>
        ...
        <h1 style={titleStyle}>Graph On Features</h1>
        <div>
        ...
        <div style={iframeContainerStyle}>
          <iframe title="dash-app" src="http://localhost:8058" style={iframeStyle}></iframe>
        </div>
      </div>
    </div>
  );
